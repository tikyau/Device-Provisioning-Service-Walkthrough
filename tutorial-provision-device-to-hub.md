...
- For TPM-based devices you need:
    ...
    [![Enrollment information for TPM in the portal](./media/tpm-device-enrollment.png)](./media/tpm-device-enrollment.png#lightbox)  
...
- For X.509 based devices you need:
    ...
    [![Add individual enrollment for X.509 attestation in the portal](./media/individual-enrollment.png)](./media/individual-enrollment.png#lightbox)
...
- **Enrollment Groups**
    ...
    [![Add group enrollment for X.509 attestation in the portal](./media/group-enrollment.png)](./media/group-enrollment.png#lightbox)
